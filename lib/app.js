...
function changeColorAnim(stickyContainer, currentCol, newCol) {
    ...
    // dragging a sticky fast between columns, won't let the code to remove the cssAnimName class on-time
    ...
    $(stickyContainer).removeClass("col1tocol2Anim").removeClass("col2tocol1Anim").removeClass("col2tocol3Anim").removeClass("col3tocol2Anim").removeClass("col3tocol4Anim").removeClass("col4tocol3Anim").removeClass("col4tocol5Anim").removeClass("col5tocol4Anim")
